...
/***/ function(module, exports, __webpack_require__) {
	...
	var Source = function (_EventEmitter) {
	  ...
	  _createClass(Source, [{
	    ...
	    value: function _initializeConstants(constants, key) {
	      if (Array.isArray(key)) {
	        for (var i = key.length - 1; i >= 0; i--) {
	          var val = constants.get(key[i]);
	          if (val) {
	            (0, _assign2.default)(this.options, val);
	          }
	        }
	      } else {
	        var _val = constants.get(key);
	        if (_val) {
	          (0, _assign2.default)(this.options, _val);
	        }
	      }
	    }
	  }, {
	    ...
	    value: function loadConstants(constants, key, func) {
	      if (constants.initialized()) {
	        ...
	        constants.once('initialized', this._initializeConstants.call(this, constants, key));
	      }
